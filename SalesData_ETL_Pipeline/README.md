...
[![PySpark](https://img.shields.io/badge/PySpark-3.5+-E25A1C?logo=apache-spark)](https://spark.apache.org)
...
2. **Catalog:** `applied_sales_data` (create if it doesn't exist)
3. **Volume:** `/Volumes/applied_sales_data/default/salesdatafiles/` containing source JSON files
4. **Permissions:**
...
1. **Daily Summary:** Group by date, region, product_line, channel
   - Total revenue, quantity, transactions
   - Average order value
   - Unique customer count

2. **Product Performance:** Group by product_line, product_sku, region
   - Revenue per product
   - Units sold
   - Average unit price

3. **Sales Rep Performance:** Group by sales_rep, region, channel
   - Total revenue per rep
   - Sales count
   - Unique customers served
   - Average deal size

4. **Regional Summary:** Group by region, year, month
